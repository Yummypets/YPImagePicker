...
class AssetVideoScrollView: UIScrollView {
    ...
    private var widthConstraint2: NSLayoutConstraint?
    ...
    private func setupSubviews() {
        ...
        widthConstraint2 = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        widthConstraint2 = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        widthConstraint2?.isActive = true
        layoutIfNeeded()
