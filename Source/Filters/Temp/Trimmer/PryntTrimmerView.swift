...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    private var leftConstraint2: NSLayoutConstraint?
    private var rightConstraint2: NSLayoutConstraint?
    ...
    private func setupTrimmerView() {
        ...
        leftConstraint2 = trimView.leftAnchor.constraint(equalTo: leftAnchor)
        rightConstraint2 = trimView.rightAnchor.constraint(equalTo: rightAnchor)
    ...
    @objc func handlePanGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            if isLeftGesture {
                currentLeftConstraint = leftConstraint2!.constant
            } else {
                currentRightConstraint = rightConstraint2!.constant
            }
    ...
    private func updateLeftConstraint(with translation: CGPoint) {
        ...
        leftConstraint2?.constant = newConstraint
    }
    ...
    private func updateRightConstraint(with translation: CGPoint) {
        ...
        rightConstraint2?.constant = newConstraint
    }
