...
public class YPLibraryVC: UIViewController, YPPermissionCheckable {
    ...
    func initialize() {
        ...
        v.collectionView.backgroundColor = YPConfig.styling.photoCollectionBackgroundColor
        v.assetViewContainer.backgroundColor = YPConfig.styling.selectedPhotoBackgroundColor
    }
